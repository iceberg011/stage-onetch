...
public class PayloadController {
    ...
    public String viewPunch(@PathVariable Integer id, HttpSession session, Model model) {
        ...
        try {
            var punchOpt = payloadService.findById(id);
            ...
            var employeeOpt = employeeService.getEmployeeById(Long.valueOf(punch.getEmpid()));
